...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		*/
		...
		{
			ParticleSystem::Sptr particleEmitter = particles1->Add<ParticleSystem>();
			particleEmitter->AddEmitter(glm::vec3(0.0f,-10.0f,0.0f), glm::vec3(5.0f, -1.0f, 10.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(5.0f, -1.0f, 12.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(5.0f, -1.0f, 14.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(5.0f, -1.0f, 16.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(5.0f, -1.0f, 18.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(-5.0f, -1.0f, 10.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(-5.0f, -1.0f, 12.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(-5.0f, -1.0f, 14.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
			particleEmitter->AddEmitter(glm::vec3(0.0f, -10.0f, 0.0f), glm::vec3(-5.0f, -1.0f, 16.0f), 15.0f, glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
