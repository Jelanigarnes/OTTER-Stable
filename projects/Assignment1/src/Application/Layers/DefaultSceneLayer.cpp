...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		//no specular
		ShaderProgram::Sptr noSpec = ResourceManager::CreateAsset<ShaderProgram>(std::unordered_map<ShaderPartType, std::string>{
			{ ShaderPartType::Vertex, "shaders/vertex_shaders/basic.glsl" },
			{ ShaderPartType::Fragment, "shaders/fragment_shaders/no_specular.glsl" }
		});
		noSpec->SetDebugName("Deferred - GBuffer Generation");
		...
		MeshResource::Sptr Character1Mesh = ResourceManager::CreateAsset<MeshResource>("models/Enemy1.obj");
		// Load in some textures
		Texture2D::Sptr    Character1Tex = ResourceManager::CreateAsset<Texture2D>("textures/LungTexture.jpg");
...
#pragma endregion 
		...
		Material::Sptr Character1Material = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			Character1Material->Name = "Character1Mat";
			Character1Material->Set("u_Material.AlbedoMap", Character1Tex);
			Character1Material->Set("u_Material.Spec", boxSpec);
			Character1Material->Set("u_Material.NormalMap", normalMapDefault);
		}
		scene->Character1Material = Character1Material;
		Material::Sptr Character1NoSpecular = ResourceManager::CreateAsset<Material>(noSpec);
		{
			Character1NoSpecular->Name = "Character1NoSpecular";
			Character1NoSpecular->Set("u_Material.AlbedoMap", Character1Tex);
			//Character1NoSpecular->Set("u_Material.Shininess", 0.1f);
			Character1NoSpecular->Set("u_Material.NormalMap", normalMapDefault);
		}
		scene->Character1NoSpecular = Character1NoSpecular;
